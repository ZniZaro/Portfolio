...
//PDFs
import curriculoPTBR from "../public/pdf/CV_NIZAR_FR.pdf";
import curriculoENUS from "../public/pdf/CV_NIZAR_EN.pdf";
...
export default function SobreMim(props) {
	...
	useEffect(() => {
		async function fetchGithubStats() {
			const response = await fetch("https://api.github.com/users/znizaro");
